...
typeset -gx HYDE_STATE_HOME="${HYDE_STATE_HOME:-$XDG_STATE_HOME/hyde}"
typeset -gx HYDE_CACHE_HOME="${HYDE_CACHE_HOME:-$XDG_CACHE_HOME/hyde}"
typeset -gx HYDE_DATA_HOME="${HYDE_DATA_HOME:-$XDG_DATA_HOME/hyde}"
